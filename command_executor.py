...
ALLOWED_COMMANDS = {
    ...
    "groupdel": {"min_args": 1, "prefix": ["groupdel"]},
    "gpasswd": {"min_args": 2, "prefix": ["gpasswd"]},
    "id": {"min_args": 1, "prefix": ["id"]},
    "getent": {"min_args": 1, "prefix": ["getent"]},
    "cat": {"min_args": 1, "prefix": ["cat"]},
...
MOCK_RESPONSES = {
    ...
    "id": {"success": True, "return_code": 0, "stdout": "1000", "stderr": ""},
    "getent": {"success": True, "return_code": 0, "stdout": "mockgroup:x:1005:", "stderr": ""},
